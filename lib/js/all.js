...
Sim.Game = (function() {
  ...
  Game.prototype.placeMenuButton = function() {
    this.menuButton || (this.menuButton = this.addButton("menu.gif", function() {
...
Sim.Menu = (function(superClass) {
  ...
  // GAMES = ['StreetGame', 'WaitGame', 'VaskaGame', 'MidsummerGame', 'WinterGame'];
  GAMES = [];
...
Sim.WinterGame = (function(superClass) {
  var WALKSPEED;

  extend(WinterGame, superClass);

  WALKSPEED = 0;

  WinterGame.prototype.setupCamera = function() {
    WinterGame.__super__.setupCamera.apply(this, arguments);
    return this.camera.position.set(9.5, 2.5, 0);
  };

  function WinterGame() {
    var hemiLight;
    WinterGame.__super__.constructor.apply(this, arguments);
    hemiLight = new THREE.HemisphereLight(0xffffff, 0xffffff, 1);
    hemiLight.position.set(0, 500, 0);
    this.scene.add(hemiLight);
    Sim.renderer.setClearColor(0);
  ...
  WinterGame.prototype.start = function() {};

  WinterGame.prototype.tick = function() {};
